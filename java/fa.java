...
public class fa {
	...
	private void initialize(String choice) {
		...
		lbl_title.setFont(new Font("«‘√ ∑“πŸ≈¡", Font.PLAIN, 18));
		...
		scrollPane_e.setBounds(12, 95, 370, 125);
