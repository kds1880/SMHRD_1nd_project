...
//		System.out.println(choice);
		...
		lbl_title.setFont(new Font("함초롬바탕", Font.PLAIN, 18));
		...
		txt_title = new JTextPane();
		txt_title.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		...
		textPane_1.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		...
		textPane.setFont(new Font("함초롬바탕", Font.PLAIN, 14));
		textPane.setText(p);
		...
		lbl_efficacy.setFont(new Font("함초롬바탕", Font.PLAIN, 18));
